...
gulp.task('css', function() {
    return gulp.src('scss/**/*.scss')
        ...
        .pipe(uncss({ // Remove unwanted css
          html: ['index.html', 'news.html', 'index-LIVE.html'], // add all pages that use this stylesheet
          ignore: ['.js', '.blur', '.hidden', '#modal-ghostbusters', '.slime', '.promo-content', '.promo-content-inner', '.popup-modal-close', '#subscribe-form', /^\.mfp/] // Don't remove dynamically inserted classes
        }))
        .pipe(gulp.dest('./css'))
