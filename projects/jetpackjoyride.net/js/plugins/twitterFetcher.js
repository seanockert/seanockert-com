    ...
    callback: function(data) {
      ...
      while(n < x) {
        ...
        if (parseLinks) {
          ...
          if (printUser) {
            op += '<div class="user"><strong>' + strip(authors[n].innerHTML) +
                '</strong> says:</div>';
          }
          if (printTime) {
            op += '<div class="timePosted">' +
                times[n].getAttribute('aria-label') + '</div><div class="clear"></div>';
          }          
          op += '<p class="tweet">' + strip(tweets[n].innerHTML) + '</p>';
        } else {
          if (tweets[n].innerText) {
            if (printUser) {
              op += '<div class="user"><strong>' + authors[n].innerText + '</strong> says:</div>';
            }
            if (printTime) {
              op += '<div class="timePosted">' + times[n].innerText + '</div><div class="clear"></div>';
            }            
            op += '<p class="tweet">' +  tweets[n].innerText + '</p>';

          } else {
            if (printUser) {
              op += '<div class="user"><strong>' + authors[n].textContent + '</strong> says:</div>';
            }
            if (printTime) {
              op += '<div class="timePosted">' + times[n].textContent + '</div><div class="clear"></div>';
            }
